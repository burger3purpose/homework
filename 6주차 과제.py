...
def showdata():
    ...
    cur = con.cursor()
    cur.execute("SELECT * FROM userTable")
    str_data1.append("사용자ID")
    str_data2.append("사용자이름")
    str_data3.append("이메일")
    str_data4.append("출생연도")
    ...
    list_data1.delete(0, list_data1.size()-1); list_data2.delete(0, list_data1.size()-1)
    list_data3.delete(0, list_data1.size()-1); list_data4.delete(0, list_data1.size()-1)
